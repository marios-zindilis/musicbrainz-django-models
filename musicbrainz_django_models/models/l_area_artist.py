"""
.. module:: l_area_artist

The **L Area Artist** Model.

PostgreSQL Definition
---------------------

The :code:`l_area_artist` table is defined in the MusicBrainz Server as:
...
class l_area_artist(models.Model):
    """
    ...
    entity0 = models.ForeignKey('area', related_name='links_to_artist')
