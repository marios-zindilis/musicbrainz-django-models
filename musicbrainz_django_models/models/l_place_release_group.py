"""
.. module:: l_place_release_group

The **L Place Release Group** Model.

PostgreSQL Definition
---------------------

The :code:`l_place_release_group` table is defined in the MusicBrainz Server as:
...
class l_place_release_group(models.Model):
    """
    ...
    entity0 = models.ForeignKey('place', related_name='links_to_release_group')
