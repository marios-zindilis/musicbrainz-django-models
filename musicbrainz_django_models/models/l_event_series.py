"""
.. module:: l_event_series

The **L Event Series** Model.

PostgreSQL Definition
---------------------

The :code:`l_event_series` table is defined in the MusicBrainz Server as:
...
class l_event_series(models.Model):
    """
    ...
    entity0 = models.ForeignKey('event', related_name='links_to_series')
