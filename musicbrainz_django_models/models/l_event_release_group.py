"""
.. module:: l_event_release_group

The **L Event Release Group** Model.

PostgreSQL Definition
---------------------

The :code:`l_event_release_group` table is defined in the MusicBrainz Server as:
...
class l_event_release_group(models.Model):
    """
    ...
    entity0 = models.ForeignKey('event', related_name='links_to_release_group')
