"""
.. module:: l_series_series

The **L Series Series** Model.

PostgreSQL Definition
---------------------

The :code:`l_series_series` table is defined in the MusicBrainz Server as:
...
class l_series_series(models.Model):
    """
    ...
    entity0 = models.ForeignKey('series', related_name='links_to_series')
