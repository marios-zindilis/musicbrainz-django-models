"""
.. module:: l_area_release

The **L Area Release** Model.

PostgreSQL Definition
---------------------

The :code:`l_area_release` table is defined in the MusicBrainz Server as:
...
class l_area_release(models.Model):
    """
    ...
    entity0 = models.ForeignKey('area', related_name='links_to_release')
