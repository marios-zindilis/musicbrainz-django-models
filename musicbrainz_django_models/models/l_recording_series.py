"""
.. module:: l_recording_series

The **L Recording Series** Model.

PostgreSQL Definition
---------------------

The :code:`l_recording_series` table is defined in the MusicBrainz Server as:
...
class l_recording_series(models.Model):
    """
    ...
    entity0 = models.ForeignKey('recording', related_name='links_to_series')
