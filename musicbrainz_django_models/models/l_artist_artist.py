"""
.. module:: l_artist_artist

The **L Artist Artist** Model.

PostgreSQL Definition
---------------------

The :code:`l_artist_artist` table is defined in the MusicBrainz Server as:
...
class l_artist_artist(models.Model):
    """
    ...
    entity0 = models.ForeignKey('artist', related_name='links_to_artist')
    entity1 = models.ForeignKey('artist')
