"""
.. module:: l_area_instrument

The **L Area Instrument** Model.

PostgreSQL Definition
---------------------

The :code:`l_area_instrument` table is defined in the MusicBrainz Server as:
...
class l_area_instrument(models.Model):
    """
    ...
    entity0 = models.ForeignKey('area', related_name='links_to_instrument')
