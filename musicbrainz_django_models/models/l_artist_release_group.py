"""
.. module:: l_artist_release_group

The **L Artist Release Group** Model.

PostgreSQL Definition
---------------------

The :code:`l_artist_release_group` table is defined in the MusicBrainz Server as:
...
class l_artist_release_group(models.Model):
    """
    ...
    entity0 = models.ForeignKey('artist', related_name='links_to_release_group')
