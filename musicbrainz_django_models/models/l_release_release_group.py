"""
.. module:: l_release_release_group

The **L Release Release Group** Model.

PostgreSQL Definition
---------------------

The :code:`l_release_release_group` table is defined in the MusicBrainz Server as:
...
class l_release_release_group(models.Model):
    """
    ...
    entity0 = models.ForeignKey('release', related_name='links_to_release_group')
    ...
    def __str__(self):
        return 'L Release Release Group'
