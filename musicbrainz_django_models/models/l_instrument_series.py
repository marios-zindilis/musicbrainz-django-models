"""
.. module:: l_instrument_series

The **L Instrument Series** Model.

PostgreSQL Definition
---------------------

The :code:`l_instrument_series` table is defined in the MusicBrainz Server as:
...
class l_instrument_series(models.Model):
    """
    ...
    entity0 = models.ForeignKey('instrument', related_name='links_to_series')
