"""
.. module:: release_group_alias

The **Release Group Alias** Model.

PostgreSQL Definition
---------------------

The :code:`release_group_alias` table is defined in the MusicBrainz Server as:
...
class release_group_alias(abstract__model_alias):
    """
    Not all parameters are listed here, only those that present some interest
    in their Django implementation.

    :param release_group: References :class:`release_group`.
    :param type: References :class:`release_group_alias_type`.
    """

    release_group = models.ForeignKey('release_group')
    type = models.ForeignKey('release_group_alias_type')
