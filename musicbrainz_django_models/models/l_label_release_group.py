"""
.. module:: l_label_release_group

The **L Label Release Group** Model.

PostgreSQL Definition
---------------------

The :code:`l_label_release_group` table is defined in the MusicBrainz Server as:
...
class l_label_release_group(models.Model):
    """
    ...
    entity0 = models.ForeignKey('label', related_name='links_to_release_group')
