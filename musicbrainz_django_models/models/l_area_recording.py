"""
.. module:: l_area_recording

The **L Area Recording** Model.

PostgreSQL Definition
---------------------

The :code:`l_area_recording` table is defined in the MusicBrainz Server as:
...
class l_area_recording(models.Model):
    """
    ...
    entity0 = models.ForeignKey('area', related_name='links_to_recording')
