"""
.. module:: l_instrument_recording

The **L Instrument Recording** Model.

PostgreSQL Definition
---------------------

The :code:`l_instrument_recording` table is defined in the MusicBrainz Server as:
...
class l_instrument_recording(models.Model):
    """
    ...
    entity0 = models.ForeignKey('instrument', related_name='links_to_recording')
    entity1 = models.ForeignKey('recording')
