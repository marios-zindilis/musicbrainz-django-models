"""
.. module:: l_release_url

The **L Release Url** Model.

PostgreSQL Definition
---------------------

The :code:`l_release_url` table is defined in the MusicBrainz Server as:
...
class l_release_url(models.Model):
    """
    ...
    entity0 = models.ForeignKey('release', related_name='links_to_url')
