"""
.. module:: l_event_event

The **L Event Event** Model.

PostgreSQL Definition
---------------------

The :code:`l_event_event` table is defined in the MusicBrainz Server as:
...
class l_event_event(models.Model):
    """
    ...
    entity0 = models.ForeignKey('event', related_name='links_to_event')
