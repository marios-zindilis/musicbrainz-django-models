"""
.. module:: l_label_series

The **L Label Series** Model.

PostgreSQL Definition
---------------------

The :code:`l_label_series` table is defined in the MusicBrainz Server as:
...
class l_label_series(models.Model):
    """
    ...
    entity0 = models.ForeignKey('label', related_name='links_to_series')
