"""
.. module:: l_label_recording

The **L Label Recording** Model.

PostgreSQL Definition
---------------------

The :code:`l_label_recording` table is defined in the MusicBrainz Server as:
...
class l_label_recording(models.Model):
    """
    ...
    entity0 = models.ForeignKey('label', related_name='links_to_recording')
