"""
.. module:: l_place_recording

The **L Place Recording** Model.

PostgreSQL Definition
---------------------

The :code:`l_place_recording` table is defined in the MusicBrainz Server as:
...
class l_place_recording(models.Model):
    """
    ...
    entity0 = models.ForeignKey('place', related_name='links_to_recording')
