"""
.. module:: l_label_release

The **L Label Release** Model.

PostgreSQL Definition
---------------------

The :code:`l_label_release` table is defined in the MusicBrainz Server as:
...
class l_label_release(models.Model):
    """
    ...
    entity0 = models.ForeignKey('label', related_name='links_to_release')
