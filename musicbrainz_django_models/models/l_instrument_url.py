"""
.. module:: l_instrument_url

The **L Instrument Url** Model.

PostgreSQL Definition
---------------------

The :code:`l_instrument_url` table is defined in the MusicBrainz Server as:
...
class l_instrument_url(models.Model):
    """
    ...
    entity0 = models.ForeignKey('instrument', related_name='links_to_url')
