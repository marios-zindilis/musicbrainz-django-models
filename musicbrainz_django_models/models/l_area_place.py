...
The **L Area Place** Model.

PostgreSQL Definition
---------------------

The :code:`l_area_place` table is defined in the MusicBrainz Server as:
...
class l_area_place(models.Model):
    """
    ...
    entity0 = models.ForeignKey('area', related_name='links_to_place')
