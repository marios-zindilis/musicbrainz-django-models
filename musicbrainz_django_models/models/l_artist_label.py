"""
.. module:: l_artist_label

The **L Artist Label** Model.

PostgreSQL Definition
---------------------

The :code:`l_artist_label` table is defined in the MusicBrainz Server as:
...
class l_artist_label(models.Model):
    """
    ...
    entity0 = models.ForeignKey('artist', related_name='links_to_label')
