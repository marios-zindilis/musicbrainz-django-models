"""
.. module:: l_instrument_release_group

The **L Instrument Release Group** Model.

PostgreSQL Definition
---------------------

The :code:`l_instrument_release_group` table is defined in the MusicBrainz Server as:
...
class l_instrument_release_group(models.Model):
    """
    ...
    entity0 = models.ForeignKey('instrument', related_name='links_to_release_group')
    ...
    def __str__(self):
        return 'L Instrument Release Group'
