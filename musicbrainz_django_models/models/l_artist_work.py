"""
.. module:: l_artist_work

The **L Artist Work** Model.

PostgreSQL Definition
---------------------

The :code:`l_artist_work` table is defined in the MusicBrainz Server as:
...
class l_artist_work(models.Model):
    """
    ...
    entity0 = models.ForeignKey('artist', related_name='links_to_work')
