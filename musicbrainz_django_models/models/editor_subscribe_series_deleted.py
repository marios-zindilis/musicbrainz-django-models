"""
.. module:: editor_subscribe_series_deleted

The **Editor Subscribe Series Deleted** Model.

PostgreSQL Definition
---------------------

The :code:`editor_subscribe_series_deleted` table is defined in the MusicBrainz Server as:
...
class editor_subscribe_series_deleted(models.Model):
    """
    ...
    def __str__(self):
        return 'Editor Subscribe Series Deleted'
