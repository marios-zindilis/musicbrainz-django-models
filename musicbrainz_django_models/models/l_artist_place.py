"""
.. module:: l_artist_place

The **L Artist Place** Model.

PostgreSQL Definition
---------------------

The :code:`l_artist_place` table is defined in the MusicBrainz Server as:
...
class l_artist_place(models.Model):
    """
    ...
    entity0 = models.ForeignKey('artist', related_name='links_to_place')
