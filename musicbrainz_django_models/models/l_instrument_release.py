"""
.. module:: l_instrument_release

The **L Instrument Release** Model.

PostgreSQL Definition
---------------------

The :code:`l_instrument_release` table is defined in the MusicBrainz Server as:
...
class l_instrument_release(models.Model):
    """
    ...
    entity0 = models.ForeignKey('instrument', related_name='links_to_release')
    entity1 = models.ForeignKey('release')
