"""
.. module:: l_event_recording

The **L Event Recording** Model.

PostgreSQL Definition
---------------------

The :code:`l_event_recording` table is defined in the MusicBrainz Server as:
...
class l_event_recording(models.Model):
    """
    ...
    entity0 = models.ForeignKey('event', related_name='links_to_recording')
