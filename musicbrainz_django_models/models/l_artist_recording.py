"""
.. module:: l_artist_recording

The **L Artist Recording** Model.

PostgreSQL Definition
---------------------

The :code:`l_artist_recording` table is defined in the MusicBrainz Server as:
...
class l_artist_recording(models.Model):
    """
    ...
    entity0 = models.ForeignKey('artist', related_name='links_to_recording')
