"""
.. module:: l_recording_recording

The **L Recording Recording** Model.

PostgreSQL Definition
---------------------

The :code:`l_recording_recording` table is defined in the MusicBrainz Server as:
...
class l_recording_recording(models.Model):
    """
    ...
    entity0 = models.ForeignKey('recording', related_name='links_to_recording')
