"""
.. module:: l_instrument_label

The **L Instrument Label** Model.

PostgreSQL Definition
---------------------

The :code:`l_instrument_label` table is defined in the MusicBrainz Server as:
...
class l_instrument_label(models.Model):
    """
    ...
    entity0 = models.ForeignKey('instrument', related_name='links_to_label')
