"""
.. module:: l_release_group_work

The **L Release Group Work** Model.

PostgreSQL Definition
---------------------

The :code:`l_release_group_work` table is defined in the MusicBrainz Server as:
...
class l_release_group_work(models.Model):
    """
    ...
    entity0 = models.ForeignKey('release_group', related_name='links_to_work')
