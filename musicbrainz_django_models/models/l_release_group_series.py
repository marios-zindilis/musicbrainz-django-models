"""
.. module:: l_release_group_series

The **L Release Group Series** Model.

PostgreSQL Definition
---------------------

The :code:`l_release_group_series` table is defined in the MusicBrainz Server as:
...
class l_release_group_series(models.Model):
    """
    ...
    entity0 = models.ForeignKey('release_group', related_name='links_to_series')
