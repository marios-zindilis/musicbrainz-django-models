"""
.. module:: l_artist_event

The **L Artist Event** Model.

PostgreSQL Definition
---------------------

The :code:`l_artist_event` table is defined in the MusicBrainz Server as:
...
class l_artist_event(models.Model):
    """
    ...
    entity0 = models.ForeignKey('artist', related_name='links_to_event')
    entity1 = models.ForeignKey('event')
