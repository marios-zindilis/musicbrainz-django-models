"""
.. module:: l_instrument_work

The **L Instrument Work** Model.

PostgreSQL Definition
---------------------

The :code:`l_instrument_work` table is defined in the MusicBrainz Server as:
...
class l_instrument_work(models.Model):
    """
    ...
    entity0 = models.ForeignKey('instrument', related_name='links_to_work')
