"""
.. module:: l_area_release_group

The **L Area Release Group** Model.

PostgreSQL Definition
---------------------

The :code:`l_area_release_group` table is defined in the MusicBrainz Server as:
...
class l_area_release_group(models.Model):
    """
    ...
    entity0 = models.ForeignKey('area', related_name='links_to_release_group')
