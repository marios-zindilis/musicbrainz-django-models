...
The **L Area Area** Model.

PostgreSQL Definition
---------------------

The :code:`l_area_area` table is defined in the MusicBrainz Server as:
...
class l_area_area(models.Model):
    """
    ...
    entity0 = models.ForeignKey('area', related_name='links_to_area')
    entity1 = models.ForeignKey('area')
