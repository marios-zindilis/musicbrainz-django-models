"""
.. module:: l_series_work

The **L Series Work** Model.

PostgreSQL Definition
---------------------

The :code:`l_series_work` table is defined in the MusicBrainz Server as:
...
class l_series_work(models.Model):
    """
    ...
    entity0 = models.ForeignKey('series', related_name='links_to_work')
