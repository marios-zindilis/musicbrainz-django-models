"""
.. module:: l_label_label

The **L Label Label** Model.

PostgreSQL Definition
---------------------

The :code:`l_label_label` table is defined in the MusicBrainz Server as:
...
class l_label_label(models.Model):
    """
    ...
    entity0 = models.ForeignKey('label', related_name='links_to_label')
