...
The **L Place Url** Model.

PostgreSQL Definition
---------------------

The :code:`l_place_url` table is defined in the MusicBrainz Server as:
...
class l_place_url(models.Model):
    """
    ...
    entity0 = models.ForeignKey('place', related_name='links_to_url')
