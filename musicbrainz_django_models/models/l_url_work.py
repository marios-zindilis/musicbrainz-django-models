...
The **L Url Work** Model.

PostgreSQL Definition
---------------------

The :code:`l_url_work` table is defined in the MusicBrainz Server as:
...
class l_url_work(models.Model):
    ...
    entity0 = models.ForeignKey('url', related_name='links_to_work')
