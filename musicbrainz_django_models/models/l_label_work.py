...
The **L Label Work** Model.

PostgreSQL Definition
---------------------

The :code:`l_label_work` table is defined in the MusicBrainz Server as:
...
class l_label_work(models.Model):
    """
    ...
    entity0 = models.ForeignKey('label', related_name='links_to_work')
