"""
.. module:: l_recording_release_group

The **L Recording Release Group** Model.

PostgreSQL Definition
---------------------

The :code:`l_recording_release_group` table is defined in the MusicBrainz Server as:
...
class l_recording_release_group(models.Model):
    """
    ...
    entity0 = models.ForeignKey('recording', related_name='links_to_release_group')
    ...
    def __str__(self):
        return 'L Recording Release Group'
