"""
.. module:: l_artist_instrument

The **L Artist Instrument** Model.

PostgreSQL Definition
---------------------

The :code:`l_artist_instrument` table is defined in the MusicBrainz Server as:
...
class l_artist_instrument(models.Model):
    """
    ...
    entity0 = models.ForeignKey('artist', related_name='links_to_instrument')
