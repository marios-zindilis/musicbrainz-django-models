...
The **L Place Work** Model.

PostgreSQL Definition
---------------------

The :code:`l_place_work` table is defined in the MusicBrainz Server as:
...
class l_place_work(models.Model):
    """
    ...
    entity0 = models.ForeignKey('place', related_name='links_to_work')
