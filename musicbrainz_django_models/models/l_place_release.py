"""
.. module:: l_place_release

The **L Place Release** Model.

PostgreSQL Definition
---------------------

The :code:`l_place_release` table is defined in the MusicBrainz Server as:
...
class l_place_release(models.Model):
    """
    ...
    entity0 = models.ForeignKey('place', related_name='links_to_release')
