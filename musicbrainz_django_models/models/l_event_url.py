...
The **L Event Url** Model.

PostgreSQL Definition
---------------------

The :code:`l_event_url` table is defined in the MusicBrainz Server as:
...
class l_event_url(models.Model):
    """
    ...
    entity0 = models.ForeignKey('event', related_name='links_to_url')
