"""
.. module:: l_recording_release

The **L Recording Release** Model.

PostgreSQL Definition
---------------------

The :code:`l_recording_release` table is defined in the MusicBrainz Server as:
...
class l_recording_release(models.Model):
    """
    ...
    entity0 = models.ForeignKey('recording', related_name='links_to_release')
