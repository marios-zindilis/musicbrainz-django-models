"""
.. module:: l_instrument_instrument

The **L Instrument Instrument** Model.

PostgreSQL Definition
---------------------

The :code:`l_instrument_instrument` table is defined in the MusicBrainz Server as:
...
class l_instrument_instrument(models.Model):
    """
    ...
    entity0 = models.ForeignKey('instrument', related_name='links_to_instrument')
    entity1 = models.ForeignKey('instrument')
    ...
    def __str__(self):
        return 'L Instrument Instrument'
