"""
.. module:: l_place_place

The **L Place Place** Model.

PostgreSQL Definition
---------------------

The :code:`l_place_place` table is defined in the MusicBrainz Server as:
...
class l_place_place(models.Model):
    """
    ...
    entity0 = models.ForeignKey('place', related_name='links_to_place')
