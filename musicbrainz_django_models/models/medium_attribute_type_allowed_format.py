"""
.. module:: medium_attribute_type_allowed_format

The **Medium Attribute Type Allowed Format** Model.

PostgreSQL Definition
---------------------

The :code:`medium_attribute_type_allowed_format` table is defined in the MusicBrainz Server as:
...
class medium_attribute_type_allowed_format(models.Model):
    """
    ...
    medium_attribute_type = models.OneToOneField('medium_attribute_type')

    def __str__(self):
        return 'Medium Attribute Type Allowed Format'
