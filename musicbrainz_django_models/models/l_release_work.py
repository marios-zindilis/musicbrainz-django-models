"""
.. module:: l_release_work

The **L Release Work** Model.

PostgreSQL Definition
---------------------

The :code:`l_release_work` table is defined in the MusicBrainz Server as:
...
class l_release_work(models.Model):
    """
    ...
    entity0 = models.ForeignKey('release', related_name='links_to_work')
