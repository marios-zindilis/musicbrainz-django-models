...
The **L Area Url** Model.

PostgreSQL Definition
---------------------

The :code:`l_area_url` table is defined in the MusicBrainz Server as:
...
class l_area_url(models.Model):
    ...
    entity0 = models.ForeignKey('area', related_name='links_to_url')
