"""
.. module:: l_event_label

The **L Event Label** Model.

PostgreSQL Definition
---------------------

The :code:`l_event_label` table is defined in the MusicBrainz Server as:
...
class l_event_label(models.Model):
    """
    ...
    entity0 = models.ForeignKey('event', related_name='links_to_label')
