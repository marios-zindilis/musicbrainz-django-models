...
The **L Event Work** Model.

PostgreSQL Definition
---------------------

The :code:`l_event_work` table is defined in the MusicBrainz Server as:
...
class l_event_work(models.Model):
    """
    ...
    entity0 = models.ForeignKey('event', related_name='links_to_work')
