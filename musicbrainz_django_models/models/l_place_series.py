"""
.. module:: l_place_series

The **L Place Series** Model.

PostgreSQL Definition
---------------------

The :code:`l_place_series` table is defined in the MusicBrainz Server as:
...
class l_place_series(models.Model):
    """
    ...
    entity0 = models.ForeignKey('place', related_name='links_to_series')
