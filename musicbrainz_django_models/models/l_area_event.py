...
The **L Area Event** Model.

PostgreSQL Definition
---------------------

The :code:`l_area_event` table is defined in the MusicBrainz Server as:
...
class l_area_event(models.Model):
    """
    ...
    entity0 = models.ForeignKey('area', related_name='links_to_event')
