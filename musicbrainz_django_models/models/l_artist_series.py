"""
.. module:: l_artist_series

The **L Artist Series** Model.

PostgreSQL Definition
---------------------

The :code:`l_artist_series` table is defined in the MusicBrainz Server as:
...
class l_artist_series(models.Model):
    """
    ...
    entity0 = models.ForeignKey('artist', related_name='links_to_series')
