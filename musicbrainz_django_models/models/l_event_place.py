"""
.. module:: l_event_place

The **L Event Place** Model.

PostgreSQL Definition
---------------------

The :code:`l_event_place` table is defined in the MusicBrainz Server as:
...
class l_event_place(models.Model):
    """
    ...
    entity0 = models.ForeignKey('event', related_name='links_to_place')
