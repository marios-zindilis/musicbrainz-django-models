...
The **L Series Url** Model.

PostgreSQL Definition
---------------------

The :code:`l_series_url` table is defined in the MusicBrainz Server as:
...
class l_series_url(models.Model):
    """
    ...
    entity0 = models.ForeignKey('series', related_name='links_to_url')
