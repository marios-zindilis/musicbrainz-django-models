...
The **L Label Url** Model.

PostgreSQL Definition
---------------------

The :code:`l_label_url` table is defined in the MusicBrainz Server as:
...
class l_label_url(models.Model):
    """
    ...
    entity0 = models.ForeignKey('label', related_name='links_to_url')
