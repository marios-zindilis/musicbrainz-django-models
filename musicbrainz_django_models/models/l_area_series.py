"""
.. module:: l_area_series

The **L Area Series** Model.

PostgreSQL Definition
---------------------

The :code:`l_area_series` table is defined in the MusicBrainz Server as:
...
class l_area_series(models.Model):
    """
    ...
    entity0 = models.ForeignKey('area', related_name='links_to_series')
