"""
.. module:: l_release_release

The **L Release Release** Model.

PostgreSQL Definition
---------------------

The :code:`l_release_release` table is defined in the MusicBrainz Server as:
...
class l_release_release(models.Model):
    """
    ...
    entity0 = models.ForeignKey('release', related_name='links_to_release')
