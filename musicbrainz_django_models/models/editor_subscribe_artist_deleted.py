"""
.. module:: editor_subscribe_artist_deleted

The **Editor Subscribe Artist Deleted** Model.

PostgreSQL Definition
---------------------

The :code:`editor_subscribe_artist_deleted` table is defined in the MusicBrainz Server as:
...
class editor_subscribe_artist_deleted(models.Model):
    """
    ...
    def __str__(self):
        return 'Editor Subscribe Artist Deleted'
