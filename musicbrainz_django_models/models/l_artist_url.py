...
The **L Artist Url** Model.

PostgreSQL Definition
---------------------

The :code:`l_artist_url` table is defined in the MusicBrainz Server as:
...
class l_artist_url(models.Model):
    """
    ...
    entity0 = models.ForeignKey('artist', related_name='links_to_url')
