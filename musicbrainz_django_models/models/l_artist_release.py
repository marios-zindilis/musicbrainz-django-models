"""
.. module:: l_artist_release

The **L Artist Release** Model.

PostgreSQL Definition
---------------------

The :code:`l_artist_release` table is defined in the MusicBrainz Server as:
...
class l_artist_release(models.Model):
    """
    ...
    entity0 = models.ForeignKey('artist', related_name='links_to_release')
