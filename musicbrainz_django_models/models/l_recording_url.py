"""
.. module:: l_recording_url

The **L Recording Url** Model.

PostgreSQL Definition
---------------------

The :code:`l_recording_url` table is defined in the MusicBrainz Server as:
...
class l_recording_url(models.Model):
    """
    ...
    entity0 = models.ForeignKey('recording', related_name='links_to_url')
