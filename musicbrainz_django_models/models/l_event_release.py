"""
.. module:: l_event_release

The **L Event Release** Model.

PostgreSQL Definition
---------------------

The :code:`l_event_release` table is defined in the MusicBrainz Server as:
...
class l_event_release(models.Model):
    """
    ...
    entity0 = models.ForeignKey('event', related_name='links_to_release')
