...
The **L Work Work** Model.

PostgreSQL Definition
---------------------

The :code:`l_work_work` table is defined in the MusicBrainz Server as:
...
class l_work_work(models.Model):
    """
    ...
    entity0 = models.ForeignKey('work', related_name='links_to_work')
